...
const AddCourse = () => {
  ...
  const { BeUrl, getToken } = useContext(AppContext);
  ...
  const [currentchapeterId, setCurrentChapterId] = useState(null);
  ...
  const addLecture = () => {
    setChapters(
      chapters.map((chapter) => {
        if (chapter.chapterId === currentchapeterId) {
          const newLecture = {
            ...lectureDetails,
            lectureOrder:
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-1 mt-2">
            ...
            <input
              ...
              min={0}
              max={100}
              className="outline-none w-28 md:py-2.5 py-2 px-3 rounded border border-gray-500"
              required
            />
          </div>
          ...
          <div>
            {chapters.map((chapter, chapterIndex) => (
              <div
                key={chapterIndex}
                className="bg-white border rounded-lg mb-4 mt-4"
              >
                <div
                  className={`flex justify-between items-center p-4 border-b ${
                    chapter.collapsed && "border-none"
                  } `}
                >
              ...
              <div className="fixed inset-0 flex items-center justify-center bg-gray-800/80 ">
                <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-86">
                  ...
                  <img
                    ...
                    className="absolute top-4 right-4 w-4 cursor-pointer hover:scale-125 duration-300 ease-in"
                    src={assets.cross_icon}
                    alt=""
                  />
                </div>
